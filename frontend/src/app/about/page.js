...
export const metadata = {
  title: 'About',
  description:
    "ZYRO's story, mission, and process — a premium energy drink built for focus, not just a buzz.",
    ...
    <>
      ...
      <section className="grid gap-0 lg:grid-cols-2">
        ...
        <div className="relative min-h-[360px]">
          <Image src={bgAtmosphere} alt="" fill sizes="50vw" className="object-cover" />
        </div>
      </section>
        ...
        <Container className="grid gap-12 lg:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-5 font-body text-sm leading-relaxed text-zyro-ink-dim">
              ...
              flavor earns its place in the range. Nothing ships because it&apos;s &quot;close
              enough.&quot;
            </p>
          </div>
          <div>
