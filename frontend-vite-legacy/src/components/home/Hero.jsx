...
export default function Hero() {
  ...
  return (
    <section ref={scope} className="relative overflow-hidden pt-28 lg:pt-32">
      <div
        className="pointer-events-none absolute -right-40 top-0 h-[600px] w-[600px] rounded-full opacity-30 blur-[120px]"
        style={{ background: 'var(--color-zyro-green)' }}
        aria-hidden="true"
      />
      <Container className="relative grid gap-12 pb-20 lg:grid-cols-2 lg:items-center lg:gap-8 lg:pb-32">
        <div className="flex flex-col gap-6">
          ...
          <p data-hero-sub className="max-w-[46ch] font-body text-lg leading-relaxed text-zyro-ink-dim">
